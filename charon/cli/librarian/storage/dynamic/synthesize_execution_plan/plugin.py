"""
Plugin entrypoint module for synthesize_execution_plan.
"""

import logging
from typing import Any, Dict

logger = logging.getLogger("Charon.Skills.SynthesizeExecutionPlan")
...
def execute_action(action_name: str, params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    # 3-Node naming convention enforced here to match manifest.json
    if action_name == "execution_plan_synthesize":
        return handle_synthesize(params)

    raise ValueError(f"Action '{action_name}' is not supported by skill 'synthesize_execution_plan'.")